...
gulp.task('build', ['browserify', 'copyData']);

gulp.task('copyData', function() {
  console.log(config.copyData.src);

  console.log(config.copyData.dest);
  return gulp.src(config.copyData.src)
    .pipe(gulp.dest(config.copyData.dest));
});
